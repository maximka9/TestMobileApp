param([string]$Godot = '', [switch]$Targeted, [switch]$SkipVisual, [switch]$NegativeControl, [switch]$NoScreenshots)
if ($NoScreenshots) { $env:SASA_NO_SCREENSHOTS = '1' }
...
try {
    ...
    $sasaSuites = @('v0112_systems', 'v0111_layout', 'v011_ui_smoke', 'v0101_systems', 'v010_systems', 'v09_systems', 'v08_systems', 'v07_systems', 'v06_systems', 'v051_stabilization', 'v05_systems')
    if (-not $Targeted) {
    ...
    if (-not $SkipVisual) {
        $sasaSmokes = @('v0112_ui', 'v0111_visual', 'v011_visual', 'v0101_ui_smoke', 'v010_ui_smoke', 'v09_ui_smoke', 'v08_ui_smoke', 'v07_ui_smoke', 'v06_ui_smoke', 'v051_ui_smoke')
