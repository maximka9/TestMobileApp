...
try {
    ...
    $sasaSuites = @('v010_systems', 'v09_systems', 'v08_systems', 'v07_systems', 'v06_systems', 'v051_stabilization', 'v05_systems')
    if (-not $Targeted) {
    ...
    if (-not $SkipVisual) {
        $sasaSmokes = @('v010_ui_smoke', 'v09_ui_smoke', 'v08_ui_smoke', 'v07_ui_smoke', 'v06_ui_smoke', 'v051_ui_smoke')
