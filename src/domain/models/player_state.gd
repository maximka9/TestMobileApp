...
var selected_cosplay_id: String = ""
var cosplay_streams: int = 0
var viral_posts: int = 0
var high_tier_collabs: int = 0
var career_tier: int = 0
var unlocked_achievements: Array[String] = []
var owned_room_items: Array[String] = []
var owned_homes: Array[String] = ["starter_home"]
...
var collab_candidate_refresh_at: int = 0
var collab_candidate_ids: Array[String] = []
var recent_candidate_ids: Array[String] = []
var incoming_collab_queue: Array[Dictionary] = []
var inbound_next_check_at: int = 0
var collab_momentum: float = 0.0
var collab_momentum_streams: int = 0
var audience_curve_version: int = 1
