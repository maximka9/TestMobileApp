...
func _run() -> void:
	...
	_check((game.room.get_node("Stage/Desk/RightMonitor/ChatStatus") as Label).get_theme_font_size("font_size") == 8, "Monitor typography resolves through Node2D parents")
